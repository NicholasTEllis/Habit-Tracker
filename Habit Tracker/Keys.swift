...
class Keys {
    ...
    // blue
    let iconColor1 = UIColor(colorLiteralRed: 30 / 255, green: 166 / 255, blue: 255 / 255, alpha: 1)
    // salmon-ey
    ...
    // Pick a color any color 112, 166, 255   
     ...
     let iconColor9 = UIColor(colorLiteralRed: 94/255, green: 209/255, blue: 195/255, alpha: 1)
